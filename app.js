...
// // BARB REF STUFF DOWN HERE BUT NOT USING IT FOR NOW //
...
//establish connection to barbRef
var barbRef = db.ref("barb");

var rssFeedName = 'https://www.google.com/alerts/feeds/14152440718877079845/10536861789733877608'

var consoleLogFunction = function (textToWrite){
...
//rssService.getRssInformation(rssFeedName, saveNewArticlesToFirebase)


// var barbResults = rssService.getRssInformation(rssFeedName, function(result){
//   result.forEach(function(entry){

//     //variables entry title
//     var thisTitle = entry.title;

//     entry.timestamp = firebase.database.ServerValue.TIMESTAMP

//     //searches the database for an entry with a similar title
//     barbRef.orderByChild('title')
//       .startAt(thisTitle)
//       .endAt(thisTitle)
//       .once('value',function(snap){
...
// var url = 'http://rivercruiseinfo.com/content/river-levels';
...
//             console.log($('table:contains(Rhine)', 'tr').html())

//             // $('table:contains(Rhine)').filter('tr').each(function(i,ele){

//             //     var thisValue = $(this).text()

//             //     console.log(thisValue);
//             //     thisArray.push(thisValue)
